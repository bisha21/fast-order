...
function CreateOrder() {
  ...
  const {username,status,position,address}= useSelector(state=>state.user)
...
const dispatch=useDispatch()
  ...
  const priorityPrice=withPriority ? 0.2*totalCartPrice: 0.0;
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center relative">
          ...
          <div className="grow">
            <input
              ...
              required
            />
            { !position.latitude & !position.longitude && <span className='absolute right-2 top-1'>
